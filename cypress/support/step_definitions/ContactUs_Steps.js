...
Then(
  "I should presented by a successfull submission of contact us message",
  () => {
...
Then(
  "I should presented by a unsuccessfull submission of contact us message",
  () => {
...
When(
  "I type specific comment message {string} and number {int}",
  (message, number) => {
...
When(
  "I type first name {word} and last name {string}",
  (firstname, lastname) => {
    cy.get('[name="first_name"]').type(firstname);
    cy.get('[name="last_name"]').type(lastname);
  }
...
Then("I should presented with {string}", (message) => {
